...
Route::get('review/{productId}/user/{userId}', [Review::class, 'show']);
Route::patch('review/{productId}/user/{userId}', [Review::class, 'update']);
Route::delete('review/{productId}/user/{userId}', [Review::class, 'destroy']);